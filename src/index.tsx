...
function usage(): void {
  ...
  console.log()
  console.log(`  ${C.cyan}workbench start${C.nc}       Start a new session (or attach to existing)`)
  ...
  console.log(`  ${C.dim}  WORKBENCH_AGENT   Default agent: claude|opencode (default: claude)${C.nc}`)
}
